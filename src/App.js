          ...
          {!isTrue && (
            <ul className="history-list-container">
              {newHistoryList.map(eachHistory => (
                <li key={eachHistory.id} className="each-history">
                  ...
                  <div className="logo-content">
                    <p className="name"> {eachHistory.title}</p>
                    <p className="website">{eachHistory.domainUrl}</p>
                  </div>
                  ...
                  <button
                    ...
                    data-testid="delete"
                    type="button"
                    onClick={() => this.FillFunction(eachHistory.id)}
                  >
                    <img
